...
const useScrollDirection = (
  ...
  useEffect(() => {
    // Pastikan ID sama persis: #zafaLottie
    const avatarContainer = document.querySelector('#zafaLottie') as HTMLElement
    
    // Tambahkan tanda tanya (?) agar tidak error jika container belum ada
    const avatarHeight = avatarContainer?.clientHeight || 0
    const avatarOffset = avatarContainer?.offsetTop || 0
    const avatarScrollY = avatarOffset + avatarHeight - AVATAR_PADD_OFFSET
